...
```
curl "https://nubesgen.com/jhipster-online-dev.tgz?iactool=TERRAFORM&region=westeurope&application=CONTAINER_APPS.basic&runtime=DOCKER&database=MYSQL.basic&gitops=true" | tar -xzvf -
```
